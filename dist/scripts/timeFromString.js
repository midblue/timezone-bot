...
const timezoneCodeToLocationData_1 = __importDefault(require("./timezoneCodeToLocationData"));
...
async function default_1(timeString = ``, msg) {
    ...
    let knownTimezoneDataForEnteredUserOrLocation, username = ``;
    // * first, check for a timezone code
    const timezoneCodeLocationData = (0, timezoneCodeToLocationData_1.default)(userOrLocation);
    ...
    if (!timezoneCodeLocationData && msg)
        ...
        targetUser = await (0, commonFunctions_1.getUserInGuildFromText)(msg, userOrLocation);
    ...
    enteredDateAsObject =
        `utcOffset` in knownTimezoneDataForEnteredUserOrLocation
            ? enteredDateAsObject.utcOffset(parseInt(knownTimezoneDataForEnteredUserOrLocation.utcOffset))
