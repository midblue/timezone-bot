...
module.exports = {
    ...
    async action({ msg, match, settings }) {
        ...
        if (!role)
            return (0, replyInChannel_1.send)(msg, `The 'role' command lists the time for everyone in a certain role. I couldn't find a role by the name you entered.`, false, settings);
