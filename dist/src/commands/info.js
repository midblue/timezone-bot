...
Support: https://discord.gg/9MKpMCV`;
        ...
        const richEmbed4 = new discord_js_light_1.default.MessageEmbed()
            .setColor(`#7B6FE5`)
            .addFields(...fields4);
        (0, replyInChannel_1.send)(msg, richEmbed1, false, settings);
        (0, replyInChannel_1.send)(msg, richEmbed2, false, settings);
        (0, replyInChannel_1.send)(msg, richEmbed3, false, settings);
        if (fields4.length)
            (0, replyInChannel_1.send)(msg, richEmbed4, false, settings);
    },
};
